class Leaderboard {
  ...
  void displayLeaderboard() {
    ...
    text("Parent Lifespan: "+oldest.lifeexpectancy,width-290,175);
    translate(0,200);
    ...
    text("Parent Lifespan: "+healthiest.lifeexpectancy,width-290,175);
    translate(0,200);
    ...
    text("Parent Lifespan: "+fittest.lifeexpectancy,width-290,175);
    translate(0,200);
